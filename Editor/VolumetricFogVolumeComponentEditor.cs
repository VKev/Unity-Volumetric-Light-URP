	...
	public override void OnInspectorGUI()
	{
		...
		if (fogVolume != null)
		{
			...
			else
			{
				...
				EditorGUILayout.HelpBox("HybridBaked uses baked volumetric textures for static baked lights and evaluates only non-baked lights in realtime. Static-visibility runtime eval is used as fallback when full baked textures are unavailable.", MessageType.None);
